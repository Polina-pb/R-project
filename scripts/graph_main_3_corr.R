...
#в конкретном месяце
methodologies_tibbles <- tibble(
  x_m = c("06", rep("01", 27),
        "10", rep("01", 3)),
  xend_m = c(rep("12", 31), "10"),
  y_m = c(rep(56.6, 5),
        rep(54.2, 5),
        rep(55.8, 6),
        rep(55, 6),
  ...
  `Год` = c(rep(c(2021, 2022, 2023, 2024, 2025), 2),
            rep(c(2020, 2021, 2022, 2023, 2024, 2025), 3),
            2020, 2021, 2022, 2023),
  color_m = c(rep("#D1705C", 5),
          rep("#D590AD", 5),
          rep("#BDD15C", 6),
          rep ("#5CBDD1", 6),
          rep("#B8C1C1", 6),
          rep("#6F5CD1", 4)),
  linewidth_m = c(rep(1.2, 32))
)
...
plot_NRA  <- ggplot()+
  ...
  geom_segment(
    data = methodologies_tibbles,
    aes(x = x_m, xend = xend_m, y = y_m, yend = yend_m),
    inherit.aes = FALSE,
    color = methodologies_tibbles$color_m,
    linewidth = methodologies_tibbles$linewidth_m
  )
